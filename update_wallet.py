...
# 1. Inject script
content = content.replace('<script src="js/web4-recovery.js"></script>', '<script src="js/web4-recovery.js"></script>\n    <script src="js/web4-mining.js"></script>')

# 2. Add fixed prices to wallet UI
wallet_ui = """      <div style="text-align: center; margin-top: 30px;">
...
content = content.replace(wallet_ui, new_wallet_ui)
